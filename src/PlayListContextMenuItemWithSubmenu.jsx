...
function PlayListContextMenuItemWithSubmenu({label, subMenuItems}) {
    ...
    return (
        <li className='relative' ref={menuItemRef} onMouseEnter={openMenu} onMouseLeave={startCloseMenuTimer}>
